    ...
    namespace dotnetapp.Services
    {
        ...
        // Enrollment data is never public: no anonymous access to any action here.
        [Authorize]
    public class CookingClassRequestController : ControllerBase
        ...
        // 1. Get All Cooking Class Requests — every learner's request, so admin only.
        ...
        // 4. Update Cooking Class Request — this is the approve/reject decision.
            [Authorize(Roles = "Admin")]
            [HttpPut("{requestId}")]
